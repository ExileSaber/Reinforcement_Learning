...
import sys
sys.path.append("../../network/cartpole_net/")
from cartpole_DQNnet_linear import DQNnet
...
class DQN(object):
    def __init__(self, n_states, n_actions, env_a_shape, args):
        self.args = args
        self.n_states = n_states
        self.n_actions = n_actions
        self.env_a_shape = env_a_shape
        # -----------Define 2 networks (target and training)------#
        self.eval_net, self.target_net = DQNnet(n_states, n_actions), DQNnet(n_states, n_actions)
