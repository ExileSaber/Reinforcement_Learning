...
import sys
sys.path.append('../../network/catchpigs_net')
from catchpigs_DQNnet_discrete import DeepNetWork
...
class DQN(object):
    def __init__(self, n_states, n_actions, args):
        ...
        self.eval_net, self.target_net = DeepNetWork(n_states, n_actions), DeepNetWork(n_states, n_actions)
